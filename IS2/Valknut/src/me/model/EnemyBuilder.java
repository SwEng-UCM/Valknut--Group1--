...
public class EnemyBuilder {
    ...
    static public Enemy buildEnemy(String str){
        ...
        switch (str.toLowerCase()) {
            case "ice":
                Enemy iceGiant = new Enemy(Messages.ICEGIANT, 20, 100, 60, Messages.ICEGIANT_ATTACK);
                element.add(2); element.add(1); element.add(1); element.add(1); element.add(1);
                iceGiant.setElementStats(element);
                return iceGiant;
            case "fire":
                Enemy fireGiant = new Enemy(Messages.FIREGIANT, 20, 100, 70, Messages.FIREGIANT_ATTACK);
                element.add(1); element.add(1); element.add(1); element.add(1); element.add(2);
                fireGiant.setElementStats(element);
                return fireGiant;
            default:
                Enemy df = new Enemy(Messages.ICEGIANT, 100, 20, 60, Messages.ICEGIANT_ATTACK);
                element.add(2); element.add(1); element.add(1); element.add(1); element.add(1);
